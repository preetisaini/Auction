...
<center>
      ...
      ResultSet rs2=st.executeQuery("select im.itemid,im.catid,im.itemname,im.startprice,im.enddate,im.seller,bi.bidderid,bi.bamt from item_master im,bidding_info bi where time_to_sec(timediff(time(sysdate()),time(im.stdate)))<300 order by itemid");
