		...
		{ 
			...
			if(bol==true)
			{
				...
				if(password.equals(pwd))
				{
					...
					String squery = "insert into item_master values("+titemid+","+catid+",'"+itemname+"','"+desc+"','"+summary+"',"+startprice+","+incrprice+",sysdate(),date_add(curdate(),INTERVAL "+acDays+" DAY),'"+seller+"',0) ";
			...
			else
			{
				pw.println("<br><br>user name does not exist");
         		...
         		{
    				pw.println("<br><br>Please login/register first");
    			}
		}
