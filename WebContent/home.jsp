   ...
   <TR>
    ...
    <A href="./registration.jsp"><STRONG>
      ...
      <A href="./ForSale.jsp"><STRONG>
        ...
        <TD>
      <A href="./Result.jsp"><STRONG>
        <FONT COLOR="BROWN">VIEW AUCTION RESULTS</STRONG>
       </A></TD>
        <TD>
...
<BR><BR>
    <BLOCKQUOTE>
     ...
     $ New Items <a href="./NewToday">Today</a>
  </BLOCKQUOTE>
<BR><BR><BR><BR>
   ...
   <TABLE height="168" width="86%" border="1">
	  ...
	  <TD vAlign="top" height="137">
		...
		<DIV align="center"><STRONG>&nbsp;|</STRONG> <A href="./NewToday">
				New Items</A>  <STRONG>|</STRONG> <A href="./sell.jsp">Sell 
